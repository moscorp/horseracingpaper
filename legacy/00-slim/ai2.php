...
//top 2x then min
//top 2 more 5x then min
//2 more below 10 then min
...
if(date("Y-m-d")==$racingdate){
    $url = "https://bet2.hkjc.com/racing/getJSON.aspx?type=winplaodds&date=".$racingdate."&venue=".$venue."&start=1&end=14";//.$end;
